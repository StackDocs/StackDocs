...
function AskOrAnnotate(props) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_svg_react_loader_name_QuestionIcon_chrome_src_icons_question_circle_svg___default.a, { className: 'chromelights-big-icon chromelights-question-icon' }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'button',
      { className: 'chromelights-btn', onClick: selectEntryType, value: true },
      'Ask'
    ),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_svg_react_loader_name_AnnotationIcon_chrome_src_icons_exclamation_circle_svg___default.a, { className: 'chromelights-big-icon chromelights-annotation-icon' }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'button',
...
//# sourceMappingURL=0.8d145e8d3ef6e5789985.hot-update.js.map